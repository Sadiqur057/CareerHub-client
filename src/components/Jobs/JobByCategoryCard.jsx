  ...
  return (
    <div className="flex">
      <div className="w-full">
        <div className="flex rounded-lg h-full bg-base-200 p-8 flex-col gap-3">
          <div>
            <div className="flex gap-6 mb-3 md:mb-2 justify-between md:justify-start">
              <h2 className="text-2xl font-semibold">{job_title}</h2>
            </div>
            <div className="flex flex-wrap items-center justify-between gap-2 md:mb-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3 justify-between items-center">
              <p className="md:text-lg nav">Application deadline: <span className="font-medium">{deadline}</span></p>
