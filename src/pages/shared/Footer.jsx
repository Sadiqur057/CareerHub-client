    ...
    <div className="bg-gray-900">
      <div className="w-[90%] pt-16 mx-auto">
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2 mt-4 lg:mt-0">
            ...
            <p className="mt-4 text-sm text-gray-500">
              Connect us and enjoy exciting services for free.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
          <p className="text-sm text-gray-500">
            © Copyright 2024 | CareerHub
          </p>
          <div className="flex items-center mt-4 space-x-4 sm:mt-0 mx-auto md:mx-0">
            <a
              href="/"
